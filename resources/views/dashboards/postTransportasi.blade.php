                                            ...
                                            <div id="grid-layout-table-1" class="box jplist">
                                                ...
                                                <div class="box text-shadow">
                                                    <table class="demo-tbl">
                                                        <!--<item>1</item>-->
                                                        @foreach($dataTransportasis as $transportasi)
                                                            <tr class="tbl-item"><!--<img/>-->
                                                                ...
                                                                <td class="td-block"><p class="date">{{ $transportasi->created_at }}</p>
                                                                    ...
                                                                    <a href="{{ route('posttransportasi.show', $transportasi->id)}}"> <p class="title">{{$transportasi->transportasi_name}}</p> </a>

                                                                    <p class="desc" align="justify">{{  str_limit($transportasi->artikel['artikel'], 305, ' ....')}}</p>
                                                                    <p class="like"></p></td>
                                                                <td class="col-md-1">
                                                                    <div class="row">
                                                                        <div class="col-md-8" style="margin:5px 0 10px 0;">
                                                                            <a href="{{ route('posttransportasi.edit', $transportasi->id)}}" class="btn btn-primary">
                                                                                <span class="fa fa-edit fa-fw" aria-hidden="true"></span>
                                                                                <span><strong>Edit &nbsp; &nbsp;&nbsp;</strong></span>
                                                                            </a>
                                                                        </div>
                                                                        <div class="col-md-8" style="margin-top:4px;">
                                                                            <form class="" action="{{ route('posttransportasi.destroy', $transportasi->id) }}" method="post" >
                                                                                {{ csrf_field() }}
                                                                                {{ method_field('DELETE') }}
